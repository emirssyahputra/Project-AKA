...
<head>
  ...
  <title>SMA S Al Kautsar| List Alat</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/tulisan/add_tulisan'?>"><span class="fa fa-plus"></span> Tambah Alat</a>
            </div>
            <!-- /.box-header -->
                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $row) :
          					   $no++;
          					   $tulisan_id=$row['tulisan_id'];
          					   $tulisan_judul=$row['tulisan_judul'];
          					   $tulisan_isi=$row['tulisan_isi'];
          					   $tulisan_tanggal=$row['tanggal'];
          					   $tulisan_author=$row['tulisan_author'];
          					   $tulisan_gambar=$row['tulisan_gambar'];
          					   $tulisan_views=$row['tulisan_views'];
                       $kategori_id=$row['tulisan_kategori_id'];
                       $kategori_nama=$row['tulisan_kategori_nama'];

                    ?>
                <tr>
                  <td><img src="<?php echo base_url().'assets/images/'.$tulisan_gambar;?>" style="width:150px;"></td>
                  ...
                  <td>
                   <?php 
					$kode = str_replace(' ', '-', $tulisan_judul);
					$gambarQR = site_url('admin/Tulisan/QRcode/'.$kode);
                    ?>
    				<img src="<?php echo $gambarQR; ?>" alt="">
                  </td>
                  <td style="text-align:right;">
                   		<a href="<?php echo $gambarQR; ?>" class="btn btn-primary btn-sm" download>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Alat Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
