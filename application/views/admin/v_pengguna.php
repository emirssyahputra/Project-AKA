...
<head>
  ...
  <title>SMA S Al Kautsar | Data Pengguna</title>
            ...
            <div class="table-responsive">
              <table id="example1" class="table table-striped" style="font-size:13px;">
				...
				<?php foreach ($data->result_array() as $i) :
                    ...
                    ?>
                <tr>
                  <td><img width="100" height="100" class="img-circle" src="<?php echo base_url().'assets/images/'.$pengguna_photo;?>"></td>
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control" name="xlevel" required>
											<?php if($pengguna_level=='1'):?>
                                                <option value="1" selected>Laboran</option>
                                                <option value="2">Guru</option>
											<?php else:?>
												<option value="1">Laboran</option>
