  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Alat</a></li>
        <li class="active">Update Alat</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Update Alat</h3>
        </div>
		<?php
        $b=$data->row_array();
    ?>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              ...
              <input type="text" name="xjudul" class="form-control" value="<?php echo $b['tulisan_judul'];?>" placeholder="Nama Alat" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-2">
