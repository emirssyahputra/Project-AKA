...
<section class="blog-wrap">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="blog-tiltle_block" style="text-align: center;">
                    <h4><a href="<?php echo site_url('artikel/'.$slug); ?>"><?php echo $title; ?></a></h4><br>
                </div>
                <div class="blog-img_block" style="text-align: center;">
            ...
            <div class="col-md-4">
              <form action="<?php echo site_url('blog/search');?>" method="get">
                  ...
                  <button type="submit" class="btn btn-warning btn-blogsearch">SEARCH</button><hr>
              </form>
